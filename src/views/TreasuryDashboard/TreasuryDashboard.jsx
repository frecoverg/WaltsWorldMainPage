...
function TreasuryDashboard() {
  ...
  useEffect(() => {
    ...
    //     staked: (parseFloat(entry.sOhmCirculatingSupply) / parseFloat(entry.WALTCirculatingSupply)) * 100,
          ...
          <Paper className="ohm-card">
            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center">
              ...
              <Box className="metric index">
                ...
                <Typography variant="h5">
                  {currentIndex ? trim(currentIndex, 2) + " sWALT" : <Skeleton type="text" />}
                </Typography>
              </Box>
            </Box>
          </Paper>

      ...
      <Paper className="ohm-card">
        <Box display="flex" flexDirection="column" alignItems="center">
          ...
          <Typography variant="h6">
            3,3 is the staking reward pool in the WaltsWorld ecosystem, similar to the Syrup Pool of PancakeSwap. By staking your sWALT with WaltsWorld, you will receive token rewards from the partners.
          </Typography>
          {/* {poolIsLocked ? (
